function [move] = Per_DDC(move_history)
    ...
    if player_last_move_1 == 1
        move = 2;

    elseif player_last_move_1 == 2 && player_last_move_2 == 1
        move = 2;

    elseif player_last_move_1 == 2 && player_last_move_2 == 2
        move = 1;
