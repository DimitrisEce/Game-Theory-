function [match_result] = Match_2(payoff_table , player_strategies , num_rounds)
    ...
    for i = 1 : num_rounds
       ...
       [move_1 , flag_1 , flag_2_1 , coop_left_1] = Move_2(player_strategies{1} , move_history(: , [1 2]) , flag_1 , flag_2_1 , coop_left_1);
       [move_2 , flag_2 , flag_2_2 , coop_left_2] = Move_2(player_strategies{2} , move_history(: , [2 1]) , flag_2 , flag_2_2 , coop_left_2);
