...
tic;
[pop_the , ~ , ~] = TourTheFit_2(B , strategies , population_vector , 6 , 250);
toc;

tic;
%[pop_sim , ~ , ~] = TourSimFit(B , strategies , population_vector , 6 , 250);
toc;
title1 = 'Theoretical CCD : 300 DDC : 244 SM : 100 / 6 rounds';
title2 = 'Simulation CCD : 300 DDC : 244 SM : 100 / 6 rounds';
